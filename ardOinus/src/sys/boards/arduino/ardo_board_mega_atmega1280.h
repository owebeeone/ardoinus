// ArdOinus specific header for board mega_atmega1280 using the atmega1280 MCU.

#ifndef ardo_board_mega_atmega1280__h
#define ardo_board_mega_atmega1280__h
...
#include "sys/mcu/avr/ardo_supplemental_atmega1280_dev.h"

namespace ardo {
namespace sys {
namespace boards {
namespace arduino {
namespace board_mega_atmega1280 {
    
namespace board_mcu = ardo::sys::avr::arch_atmega1280;
...
} // board_mega_atmega1280
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_mega_atmega1280__h
