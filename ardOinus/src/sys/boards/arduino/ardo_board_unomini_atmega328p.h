// ArdOinus specific header for board unomini_atmega328p using the atmega328p MCU.

#ifndef ardo_board_unomini_atmega328p__h
#define ardo_board_unomini_atmega328p__h
...
namespace boards {
namespace arduino {
namespace board_unomini_atmega328p {
...
} // board_unomini_atmega328p
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_unomini_atmega328p__h
