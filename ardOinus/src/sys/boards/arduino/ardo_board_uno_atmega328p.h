// ArdOinus specific header for board uno_atmega328p using the atmega328p MCU.

#ifndef ardo_board_uno_atmega328p__h
#define ardo_board_uno_atmega328p__h
...
namespace boards {
namespace arduino {
namespace board_uno_atmega328p {
...
} // board_uno_atmega328p
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_uno_atmega328p__h
