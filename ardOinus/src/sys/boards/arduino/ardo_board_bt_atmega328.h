// ArdOinus specific header for board bt_atmega328 using the atmega328p MCU.

#ifndef ardo_board_bt_atmega328__h
#define ardo_board_bt_atmega328__h
...
#endif  // ardo_board_bt_atmega328__h
