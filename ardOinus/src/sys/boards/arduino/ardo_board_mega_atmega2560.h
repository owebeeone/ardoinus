// ArdOinus specific header for board mega_atmega2560 using the atmega2560 MCU.

#ifndef ardo_board_mega_atmega2560__h
#define ardo_board_mega_atmega2560__h
...
#include "sys/mcu/avr/ardo_supplemental_atmega2560_dev.h"

namespace ardo {
namespace sys {
namespace boards {
namespace arduino {
namespace board_mega_atmega2560 {
...
} // board_mega_atmega2560
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_mega_atmega2560__h
