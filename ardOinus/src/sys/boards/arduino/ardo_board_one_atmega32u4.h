// ArdOinus specific header for board one_atmega32u4 using the atmega32u4 MCU.

#ifndef ardo_board_one_atmega32u4__h
#define ardo_board_one_atmega32u4__h
...
namespace boards {
namespace arduino {
namespace board_one_atmega32u4 {
...
} // board_one_atmega32u4
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_one_atmega32u4__h
