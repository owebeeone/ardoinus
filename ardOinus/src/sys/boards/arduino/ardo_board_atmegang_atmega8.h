// ArdOinus specific header for board atmegang_atmega8 using the atmega8 MCU.

#ifndef ardo_board_atmegang_atmega8__h
#define ardo_board_atmegang_atmega8__h
...
#include "sys/mcu/avr/ardo_supplemental_atmega8_dev.h"

namespace ardo {
namespace sys {
namespace boards {
namespace arduino {
namespace board_atmegang_atmega8 {
    
namespace board_mcu = ardo::sys::avr::arch_atmega8;
...
} // board_atmegang_atmega8
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_atmegang_atmega8__h
