// ArdOinus specific header for board circuitplay32u4cat_atmega32u4 using the atmega32u4 MCU.

#ifndef ardo_board_circuitplay32u4cat_atmega32u4__h
#define ardo_board_circuitplay32u4cat_atmega32u4__h
...
#include "sys/mcu/avr/ardo_supplemental_atmega32u4_dev.h"

namespace ardo {
namespace sys {
namespace boards {
namespace arduino {
namespace board_circuitplay32u4cat_atmega32u4 {
...
} // board_circuitplay32u4cat_atmega32u4
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_circuitplay32u4cat_atmega32u4__h
