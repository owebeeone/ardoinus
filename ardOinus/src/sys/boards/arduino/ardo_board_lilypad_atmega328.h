// ArdOinus specific header for board lilypad_atmega328 using the atmega328p MCU.

#ifndef ardo_board_lilypad_atmega328__h
#define ardo_board_lilypad_atmega328__h
...
namespace boards {
namespace arduino {
namespace board_lilypad_atmega328 {
...
} // board_lilypad_atmega328
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_lilypad_atmega328__h
