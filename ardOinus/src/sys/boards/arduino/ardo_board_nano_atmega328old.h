// ArdOinus specific header for board nano_atmega328old using the atmega328p MCU.

#ifndef ardo_board_nano_atmega328old__h
#define ardo_board_nano_atmega328old__h
...
namespace boards {
namespace arduino {
namespace board_nano_atmega328old {
...
} // board_nano_atmega328old
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_nano_atmega328old__h
