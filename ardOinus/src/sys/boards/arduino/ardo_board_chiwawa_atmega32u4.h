// ArdOinus specific header for board chiwawa_atmega32u4 using the atmega32u4 MCU.

#ifndef ardo_board_chiwawa_atmega32u4__h
#define ardo_board_chiwawa_atmega32u4__h
...
namespace boards {
namespace arduino {
namespace board_chiwawa_atmega32u4 {
...
} // board_chiwawa_atmega32u4
} // arduino
} // boards
} // sys
} // ardo

#endif  // ardo_board_chiwawa_atmega32u4__h
