// ArdOinus specific header for board bt_atmega168 using the atmega168 MCU.

#ifndef ardo_board_bt_atmega168__h
#define ardo_board_bt_atmega168__h
...
#endif  // ardo_board_bt_atmega168__h
