// Generated for arch attiny43u.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny43u from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny43u_defs.h.

#ifndef ardo_supplemental_attiny43u__h
#define ardo_supplemental_attiny43u__h
...
constexpr unsigned ccADC_vect_num = 12;
...
constexpr unsigned ccAIN0D = 4;
constexpr unsigned ccAIN1D = 5;
constexpr unsigned ccANA_COMP_vect_num = 11;
...
constexpr unsigned ccEE_RDY_vect_num = 13;
...
using rrOCR1A = IoRegisterDef<std::uint8_t, 0x2C>;
constexpr unsigned ccOCR1A_0 = 0;
constexpr unsigned ccOCR1A_1 = 1;
using rrOCR1B = IoRegisterDef<std::uint8_t, 0x2B>;
constexpr unsigned ccOCR1B_0 = 0;
constexpr unsigned ccOCR1B_1 = 1;
constexpr unsigned ccOCR1B_2 = 2;
constexpr unsigned ccOCR1B_3 = 3;
constexpr unsigned ccOCR1B_4 = 4;
constexpr unsigned ccOCR1B_5 = 5;
constexpr unsigned ccOCR1B_6 = 6;
constexpr unsigned ccOCR1B_7 = 7;
constexpr unsigned ccOCRA1_2 = 2;
constexpr unsigned ccOCRA1_3 = 3;
constexpr unsigned ccOCRA1_4 = 4;
constexpr unsigned ccOCRA1_5 = 5;
constexpr unsigned ccOCRA1_6 = 6;
constexpr unsigned ccOCRA1_7 = 7;
...
using rrTCNT1 = IoRegisterDef<std::uint8_t, 0x2D>;
...
constexpr unsigned ccTIM0_COMPA_vect_num = 8;
constexpr unsigned ccTIM0_COMPB_vect_num = 9;
constexpr unsigned ccTIM0_OVF_vect_num = 10;
constexpr unsigned ccTIM1_COMPA_vect_num = 5;
constexpr unsigned ccTIM1_COMPB_vect_num = 6;
constexpr unsigned ccTIM1_OVF_vect_num = 7;
...
constexpr unsigned ccUSI_OVF_vect_num = 15;
constexpr unsigned ccUSI_START_vect_num = 14;
...
#endif  // ardo_supplemental_attiny43u__h
