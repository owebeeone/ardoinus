...
#include "sys/mcu/avr/base/ardo_avr_base.h"
...
using ardo::sys::avr::base::Dependency;
using ardo::sys::avr::base::ResourceType;
using ardo::sys::avr::base::RootDependencies;
using ardo::sys::avr::base::ResourceFinder;
using ardo::sys::avr::base::Register;
...
// using Register = ::ardo::sys::avr::base::Register<w_BitfieldType, w_Register, RegisterType>;
