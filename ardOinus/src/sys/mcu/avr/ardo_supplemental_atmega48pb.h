// Generated for arch atmega48pb.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega48pb from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega48pb_defs.h.

#ifndef ardo_supplemental_atmega48pb__h
#define ardo_supplemental_atmega48pb__h
...
using rrACSRB = IoRegisterDef<std::uint8_t, 0x0F>;
...
using rrDEVID0 = MemRegisterDef<std::uint8_t, 0xF0>;
using rrDEVID1 = MemRegisterDef<std::uint8_t, 0xF1>;
using rrDEVID2 = MemRegisterDef<std::uint8_t, 0xF2>;
using rrDEVID3 = MemRegisterDef<std::uint8_t, 0xF3>;
using rrDEVID4 = MemRegisterDef<std::uint8_t, 0xF4>;
using rrDEVID5 = MemRegisterDef<std::uint8_t, 0xF5>;
using rrDEVID6 = MemRegisterDef<std::uint8_t, 0xF6>;
using rrDEVID7 = MemRegisterDef<std::uint8_t, 0xF7>;
using rrDEVID8 = MemRegisterDef<std::uint8_t, 0xF8>;
...
constexpr unsigned ccUSART_START_vect_num = 26;
...
#endif  // ardo_supplemental_atmega48pb__h
