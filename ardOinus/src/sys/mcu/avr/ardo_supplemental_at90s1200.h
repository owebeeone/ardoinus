// Generated for arch at90s1200.
// This file is generated from the avr-gcc compiler with the mcu
// set to at90s1200 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_at90s1200_defs.h.

#ifndef ardo_supplemental_at90s1200__h
#define ardo_supplemental_at90s1200__h
...
constexpr unsigned ccANA_COMP_vect_num = 3;
...
using ffFUSE_RCEN = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_RCEN"), bool>, 1u<<0>;
...
constexpr unsigned ccTIMER0_OVF_vect_num = 2;
...
constexpr unsigned cc_VECTORS_SIZE = 8;
...
#endif  // ardo_supplemental_at90s1200__h
