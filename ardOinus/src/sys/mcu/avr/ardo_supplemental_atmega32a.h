// Generated for arch atmega32a.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega32a from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega32a_defs.h.

#ifndef ardo_supplemental_atmega32a__h
#define ardo_supplemental_atmega32a__h
...
constexpr unsigned ccPSR2 = 0;
constexpr unsigned ccPUD = 2;
constexpr unsigned ccRAMEND = 0x085F;
constexpr unsigned ccRAMSIZE = 2048;
constexpr unsigned ccRAMSTART = 0x0060;
...
#endif  // ardo_supplemental_atmega32a__h
