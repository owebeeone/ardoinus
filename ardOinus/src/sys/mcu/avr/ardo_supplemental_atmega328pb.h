// Generated for arch atmega328pb.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega328pb from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega328pb_defs.h.

#ifndef ardo_supplemental_atmega328pb__h
#define ardo_supplemental_atmega328pb__h
...
constexpr unsigned ccCFD_vect_num = 36;
...
constexpr unsigned ccCPHA1 = 2;
constexpr unsigned ccCPOL = 3;
constexpr unsigned ccCPOL1 = 3;
...
constexpr unsigned ccPCINT3_vect_num = 27;
...
constexpr unsigned ccPTC_EOC_vect_num = 37;
constexpr unsigned ccPTC_WCOMP_vect_num = 38;
...
constexpr unsigned ccSIGNATURE_2 = 0x16;
...
constexpr unsigned ccSPE1 = 6;
using rrSPH = IoRegisterDef<std::uint8_t, 0x3E>;
constexpr unsigned ccSPI0_STC_vect_num = 17;
constexpr unsigned ccSPI1_STC_vect_num = 39;
constexpr unsigned ccSPI2X = 0;
constexpr unsigned ccSPI2X1 = 0;
constexpr unsigned ccSPIE = 7;
constexpr unsigned ccSPIE1 = 7;
constexpr unsigned ccSPIF = 7;
constexpr unsigned ccSPIF1 = 7;
...
constexpr unsigned ccSPR10 = 0;
constexpr unsigned ccSPR11 = 1;
...
constexpr unsigned ccTIMER3_CAPT_vect_num = 32;
constexpr unsigned ccTIMER3_COMPA_vect_num = 33;
constexpr unsigned ccTIMER3_COMPB_vect_num = 34;
...
constexpr unsigned ccTIMER4_OVF_vect_num = 44;
...
constexpr unsigned ccTWEA1 = 6;
constexpr unsigned ccTWEN = 2;
constexpr unsigned ccTWEN1 = 2;
constexpr unsigned ccTWGCE = 0;
constexpr unsigned ccTWI0_vect_num = 24;
constexpr unsigned ccTWI1_vect_num = 40;
constexpr unsigned ccTWIE = 0;
constexpr unsigned ccTWIE1 = 0;
constexpr unsigned ccTWINT = 7;
constexpr unsigned ccTWINT1 = 7;
constexpr unsigned ccTWPS0 = 0;
constexpr unsigned ccTWPS1 = 1;
constexpr unsigned ccTWPS10 = 0;
constexpr unsigned ccTWPS11 = 1;
constexpr unsigned ccTWS13 = 3;
constexpr unsigned ccTWS14 = 4;
constexpr unsigned ccTWS15 = 5;
constexpr unsigned ccTWS16 = 6;
constexpr unsigned ccTWS17 = 7;
...
constexpr unsigned ccTWSTA1 = 5;
constexpr unsigned ccTWSTO = 4;
constexpr unsigned ccTWSTO1 = 4;
constexpr unsigned ccTWWC = 3;
constexpr unsigned ccTWWC1 = 3;
...
constexpr unsigned ccUSART0_START_vect_num = 26;
...
constexpr unsigned ccUSART1_START_vect_num = 31;
...
constexpr unsigned cc_VECTORS_SIZE = 180;
...
#endif  // ardo_supplemental_atmega328pb__h
