// Generated for arch attiny85.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny85 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny85_defs.h.

#ifndef ardo_supplemental_attiny85__h
#define ardo_supplemental_attiny85__h
...
using rrDT1A = IoRegisterDef<std::uint8_t, 0x25>;
constexpr unsigned ccDT1AH0 = 4;
constexpr unsigned ccDT1AH1 = 5;
constexpr unsigned ccDT1AH2 = 6;
constexpr unsigned ccDT1AH3 = 7;
constexpr unsigned ccDT1AL0 = 0;
constexpr unsigned ccDT1AL1 = 1;
constexpr unsigned ccDT1AL2 = 2;
constexpr unsigned ccDT1AL3 = 3;
using rrDT1B = IoRegisterDef<std::uint8_t, 0x24>;
constexpr unsigned ccDT1BH0 = 4;
constexpr unsigned ccDT1BH1 = 5;
constexpr unsigned ccDT1BH2 = 6;
constexpr unsigned ccDT1BH3 = 7;
constexpr unsigned ccDT1BL0 = 0;
constexpr unsigned ccDT1BL1 = 1;
constexpr unsigned ccDT1BL2 = 2;
constexpr unsigned ccDT1BL3 = 3;
using rrDTPS1 = IoRegisterDef<std::uint8_t, 0x23>;
constexpr unsigned ccDTPS10 = 0;
constexpr unsigned ccDTPS11 = 1;
using rrDWDR = IoRegisterDef<std::uint8_t, 0x22>;
...
using rrGPIOR0 = IoRegisterDef<std::uint8_t, 0x11>;
using rrGPIOR1 = IoRegisterDef<std::uint8_t, 0x12>;
using rrGPIOR2 = IoRegisterDef<std::uint8_t, 0x13>;
using rrGTCCR = IoRegisterDef<std::uint8_t, 0x2C>;
...
using rrOCR0A = IoRegisterDef<std::uint8_t, 0x29>;
...
using rrOCR1C = IoRegisterDef<std::uint8_t, 0x2D>;
...
using rrPLLCSR = IoRegisterDef<std::uint8_t, 0x27>;
...
using rrPRR = IoRegisterDef<std::uint8_t, 0x20>;
...
constexpr unsigned ccPWM1A = 6;
constexpr unsigned ccPWM1B = 6;
...
using rrTCCR0A = IoRegisterDef<std::uint8_t, 0x2A>;
...
constexpr unsigned ccTIM1_COMPA_vect_num = 3;
constexpr unsigned ccTIM1_COMPB_vect_num = 9;
constexpr unsigned ccTIM1_OVF_vect_num = 4;
...
constexpr unsigned ccUSI_OVF_vect_num = 14;
constexpr unsigned ccUSI_START_vect_num = 13;
...
#endif  // ardo_supplemental_attiny85__h
