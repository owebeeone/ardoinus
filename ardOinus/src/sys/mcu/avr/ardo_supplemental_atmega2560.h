// Generated for arch atmega2560.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega2560 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega2560_defs.h.

#ifndef ardo_supplemental_atmega2560__h
#define ardo_supplemental_atmega2560__h
...
constexpr unsigned ccDDJ7 = 7;
constexpr unsigned ccDDK0 = 0;
constexpr unsigned ccDDK1 = 1;
constexpr unsigned ccDDK2 = 2;
constexpr unsigned ccDDK3 = 3;
constexpr unsigned ccDDK4 = 4;
constexpr unsigned ccDDK5 = 5;
constexpr unsigned ccDDK6 = 6;
constexpr unsigned ccDDK7 = 7;
constexpr unsigned ccDDL0 = 0;
constexpr unsigned ccDDL1 = 1;
constexpr unsigned ccDDL2 = 2;
constexpr unsigned ccDDL3 = 3;
constexpr unsigned ccDDL4 = 4;
constexpr unsigned ccDDL5 = 5;
constexpr unsigned ccDDL6 = 6;
constexpr unsigned ccDDL7 = 7;
...
using rrDDRH = MemRegisterDef<std::uint8_t, 0x101>;
using rrDDRJ = MemRegisterDef<std::uint8_t, 0x104>;
using rrDDRK = MemRegisterDef<std::uint8_t, 0x107>;
using rrDDRL = MemRegisterDef<std::uint8_t, 0x10A>;
...
constexpr unsigned ccDOR2 = 3;
constexpr unsigned ccDOR3 = 3;
...
constexpr unsigned ccFE2 = 4;
constexpr unsigned ccFE3 = 4;
...
constexpr unsigned ccMPCM2 = 0;
constexpr unsigned ccMPCM3 = 0;
...
using rrPINH = MemRegisterDef<std::uint8_t, 0x100>;
...
using rrPINJ = MemRegisterDef<std::uint8_t, 0x103>;
...
constexpr unsigned ccPINJ7 = 7;
using rrPINK = MemRegisterDef<std::uint8_t, 0x106>;
constexpr unsigned ccPINK0 = 0;
constexpr unsigned ccPINK1 = 1;
constexpr unsigned ccPINK2 = 2;
constexpr unsigned ccPINK3 = 3;
constexpr unsigned ccPINK4 = 4;
constexpr unsigned ccPINK5 = 5;
constexpr unsigned ccPINK6 = 6;
constexpr unsigned ccPINK7 = 7;
using rrPINL = MemRegisterDef<std::uint8_t, 0x109>;
constexpr unsigned ccPINL0 = 0;
constexpr unsigned ccPINL1 = 1;
constexpr unsigned ccPINL2 = 2;
constexpr unsigned ccPINL3 = 3;
constexpr unsigned ccPINL4 = 4;
constexpr unsigned ccPINL5 = 5;
constexpr unsigned ccPINL6 = 6;
constexpr unsigned ccPINL7 = 7;
...
constexpr unsigned ccPJ7 = 7;
constexpr unsigned ccPK0 = 0;
constexpr unsigned ccPK1 = 1;
constexpr unsigned ccPK2 = 2;
constexpr unsigned ccPK3 = 3;
constexpr unsigned ccPK4 = 4;
constexpr unsigned ccPK5 = 5;
constexpr unsigned ccPK6 = 6;
constexpr unsigned ccPK7 = 7;
constexpr unsigned ccPL0 = 0;
constexpr unsigned ccPL1 = 1;
constexpr unsigned ccPL2 = 2;
constexpr unsigned ccPL3 = 3;
constexpr unsigned ccPL4 = 4;
constexpr unsigned ccPL5 = 5;
constexpr unsigned ccPL6 = 6;
constexpr unsigned ccPL7 = 7;
...
using rrPORTH = MemRegisterDef<std::uint8_t, 0x102>;
using rrPORTJ = MemRegisterDef<std::uint8_t, 0x105>;
using rrPORTK = MemRegisterDef<std::uint8_t, 0x108>;
using rrPORTL = MemRegisterDef<std::uint8_t, 0x10B>;
...
constexpr unsigned ccRXB82 = 1;
constexpr unsigned ccRXB83 = 1;
constexpr unsigned ccRXC0 = 7;
constexpr unsigned ccRXC1 = 7;
constexpr unsigned ccRXC2 = 7;
constexpr unsigned ccRXC3 = 7;
constexpr unsigned ccRXCIE0 = 7;
constexpr unsigned ccRXCIE1 = 7;
constexpr unsigned ccRXCIE2 = 7;
constexpr unsigned ccRXCIE3 = 7;
constexpr unsigned ccRXEN0 = 4;
constexpr unsigned ccRXEN1 = 4;
constexpr unsigned ccRXEN2 = 4;
constexpr unsigned ccRXEN3 = 4;
...
constexpr unsigned ccTXB82 = 0;
constexpr unsigned ccTXB83 = 0;
constexpr unsigned ccTXC0 = 6;
constexpr unsigned ccTXC1 = 6;
constexpr unsigned ccTXC2 = 6;
constexpr unsigned ccTXC3 = 6;
constexpr unsigned ccTXCIE0 = 6;
constexpr unsigned ccTXCIE1 = 6;
constexpr unsigned ccTXCIE2 = 6;
constexpr unsigned ccTXCIE3 = 6;
constexpr unsigned ccTXEN0 = 3;
constexpr unsigned ccTXEN1 = 3;
constexpr unsigned ccTXEN2 = 3;
constexpr unsigned ccTXEN3 = 3;
constexpr unsigned ccU2X0 = 1;
constexpr unsigned ccU2X1 = 1;
constexpr unsigned ccU2X2 = 1;
constexpr unsigned ccU2X3 = 1;
...
using rrUBRR3 = MemRegisterDef<std::uint16_t, 0x134>;
using rrUBRR3H = MemRegisterDef<std::uint8_t, 0x135>;
using rrUBRR3L = MemRegisterDef<std::uint8_t, 0x134>;
constexpr unsigned ccUCPOL0 = 0;
constexpr unsigned ccUCPOL1 = 0;
constexpr unsigned ccUCPOL2 = 0;
constexpr unsigned ccUCPOL3 = 0;
...
using rrUCSR3A = MemRegisterDef<std::uint8_t, 0x130>;
using rrUCSR3C = MemRegisterDef<std::uint8_t, 0x132>;
...
constexpr unsigned ccUCSZ20 = 1;
constexpr unsigned ccUCSZ21 = 2;
constexpr unsigned ccUCSZ22 = 2;
constexpr unsigned ccUCSZ30 = 1;
constexpr unsigned ccUCSZ31 = 2;
constexpr unsigned ccUCSZ32 = 2;
constexpr unsigned ccUDRE0 = 5;
constexpr unsigned ccUDRE1 = 5;
constexpr unsigned ccUDRE2 = 5;
constexpr unsigned ccUDRE3 = 5;
constexpr unsigned ccUDRIE0 = 5;
constexpr unsigned ccUDRIE1 = 5;
constexpr unsigned ccUDRIE2 = 5;
constexpr unsigned ccUDRIE3 = 5;
constexpr unsigned ccUMSEL00 = 6;
constexpr unsigned ccUMSEL01 = 7;
constexpr unsigned ccUMSEL10 = 6;
constexpr unsigned ccUMSEL11 = 7;
constexpr unsigned ccUMSEL20 = 6;
constexpr unsigned ccUMSEL21 = 7;
constexpr unsigned ccUMSEL30 = 6;
constexpr unsigned ccUMSEL31 = 7;
constexpr unsigned ccUPE0 = 2;
constexpr unsigned ccUPE1 = 2;
constexpr unsigned ccUPE2 = 2;
constexpr unsigned ccUPE3 = 2;
constexpr unsigned ccUPM00 = 4;
constexpr unsigned ccUPM01 = 5;
constexpr unsigned ccUPM10 = 4;
constexpr unsigned ccUPM11 = 5;
constexpr unsigned ccUPM20 = 4;
constexpr unsigned ccUPM21 = 5;
constexpr unsigned ccUPM30 = 4;
constexpr unsigned ccUPM31 = 5;
...
constexpr unsigned ccUSART2_RX_vect_num = 51;
constexpr unsigned ccUSART2_TX_vect_num = 53;
constexpr unsigned ccUSART2_UDRE_vect_num = 52;
constexpr unsigned ccUSART3_RX_vect_num = 54;
constexpr unsigned ccUSART3_TX_vect_num = 56;
constexpr unsigned ccUSART3_UDRE_vect_num = 55;
constexpr unsigned ccUSBS0 = 3;
constexpr unsigned ccUSBS1 = 3;
constexpr unsigned ccUSBS2 = 3;
constexpr unsigned ccUSBS3 = 3;
...
constexpr unsigned cc_VECTORS_SIZE = 228;
...
#endif  // ardo_supplemental_atmega2560__h
