// Generated for arch atmega163.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega163 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega163_defs.h.

#ifndef ardo_supplemental_atmega163__h
#define ardo_supplemental_atmega163__h
...
constexpr unsigned ccUART_RX_vect_num = 11;
constexpr unsigned ccUART_TX_vect_num = 13;
constexpr unsigned ccUART_UDRE_vect_num = 12;
using rrUBRR = IoRegisterDef<std::uint8_t, 0x09>;
using rrUBRRHI = IoRegisterDef<std::uint8_t, 0x20>;
...
constexpr unsigned cc_VECTORS_SIZE = 72;
...
#endif  // ardo_supplemental_atmega163__h
