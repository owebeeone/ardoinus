// Generated for arch atmega324pa.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega324pa from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega324pa_defs.h.

#ifndef ardo_supplemental_atmega324pa__h
#define ardo_supplemental_atmega324pa__h
...
constexpr unsigned ccCPHA0 = 2;
constexpr unsigned ccCPOL0 = 3;
...
constexpr unsigned ccSPDRB0 = 0;
constexpr unsigned ccSPDRB1 = 1;
constexpr unsigned ccSPDRB2 = 2;
constexpr unsigned ccSPDRB3 = 3;
constexpr unsigned ccSPDRB4 = 4;
constexpr unsigned ccSPDRB5 = 5;
constexpr unsigned ccSPDRB6 = 6;
constexpr unsigned ccSPDRB7 = 7;
constexpr unsigned ccSPE0 = 6;
using rrSPH = IoRegisterDef<std::uint8_t, 0x3E>;
constexpr unsigned ccSPI2X0 = 0;
constexpr unsigned ccSPIE0 = 7;
constexpr unsigned ccSPIF0 = 7;
...
constexpr unsigned ccSPR00 = 0;
constexpr unsigned ccSPR10 = 1;
...
#endif  // ardo_supplemental_atmega324pa__h
