// Generated for arch atmega88pa.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega88pa from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega88pa_defs.h.

#ifndef ardo_supplemental_atmega88pa__h
#define ardo_supplemental_atmega88pa__h
...
constexpr unsigned ccAIN0_BIT = 6;
constexpr unsigned ccAIN1D = 1;
constexpr unsigned ccAIN1_BIT = 7;
...
constexpr unsigned ccCLKO_BIT = 0;
...
constexpr unsigned ccICP1_BIT = 0;
...
constexpr unsigned ccMISO_BIT = 4;
constexpr unsigned ccMOSI_BIT = 3;
...
constexpr unsigned ccOC0A_BIT = 6;
constexpr unsigned ccOC0B_BIT = 5;
constexpr unsigned ccOC1A_BIT = 1;
constexpr unsigned ccOC1B_BIT = 2;
constexpr unsigned ccOC2A_BIT = 3;
constexpr unsigned ccOC2B_BIT = 3;
...
constexpr unsigned ccSCK_BIT = 5;
constexpr unsigned ccSCL_BIT = 5;
constexpr unsigned ccSDA_BIT = 4;
...
constexpr unsigned ccXCK_BIT = 4;
...
#endif  // ardo_supplemental_atmega88pa__h
