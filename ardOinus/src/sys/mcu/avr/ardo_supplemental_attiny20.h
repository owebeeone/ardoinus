// Generated for arch attiny20.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny20 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny20_defs.h.

#ifndef ardo_supplemental_attiny20__h
#define ardo_supplemental_attiny20__h
...
constexpr unsigned ccADC_ADC_vect_num = 13;
...
using rrGTCCR = IoRegisterDef<std::uint8_t, 0x27>;
...
using rrICR1 = IoRegisterDef<std::uint16_t, 0x1A>;
using rrICR1H = IoRegisterDef<std::uint8_t, 0x1B>;
using rrICR1L = IoRegisterDef<std::uint8_t, 0x1A>;
constexpr unsigned ccICR1_0 = 0;
constexpr unsigned ccICR1_1 = 1;
constexpr unsigned ccICR1_10 = 2;
constexpr unsigned ccICR1_11 = 3;
constexpr unsigned ccICR1_12 = 4;
constexpr unsigned ccICR1_13 = 5;
constexpr unsigned ccICR1_14 = 6;
constexpr unsigned ccICR1_15 = 7;
constexpr unsigned ccICR1_2 = 2;
constexpr unsigned ccICR1_3 = 3;
constexpr unsigned ccICR1_4 = 4;
constexpr unsigned ccICR1_5 = 5;
constexpr unsigned ccICR1_6 = 6;
constexpr unsigned ccICR1_7 = 7;
constexpr unsigned ccICR1_8 = 0;
constexpr unsigned ccICR1_9 = 1;
...
using rrOCR1A = IoRegisterDef<std::uint16_t, 0x1E>;
...
using rrOCR1AH = IoRegisterDef<std::uint8_t, 0x1F>;
using rrOCR1AL = IoRegisterDef<std::uint8_t, 0x1E>;
using rrOCR1B = IoRegisterDef<std::uint16_t, 0x1C>;
...
using rrOCR1BH = IoRegisterDef<std::uint8_t, 0x1D>;
using rrOCR1BL = IoRegisterDef<std::uint8_t, 0x1C>;
...
constexpr unsigned ccQTRIP_vect_num = 16;
...
constexpr unsigned ccSIGNATURE_2 = 0x0F;
...
constexpr unsigned ccSPI_vect_num = 15;
...
using rrTCCR1B = IoRegisterDef<std::uint8_t, 0x23>;
...
using rrTCNT1 = IoRegisterDef<std::uint16_t, 0x20>;
using rrTCNT1H = IoRegisterDef<std::uint8_t, 0x21>;
using rrTCNT1L = IoRegisterDef<std::uint8_t, 0x20>;
...
constexpr unsigned ccTWI_SLAVE_vect_num = 14;
...
#endif  // ardo_supplemental_attiny20__h
