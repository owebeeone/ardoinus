// Generated for arch atmega32hvbrevb.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega32hvbrevb from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega32hvbrevb_defs.h.

#ifndef ardo_supplemental_atmega32hvbrevb__h
#define ardo_supplemental_atmega32hvbrevb__h
...
using rrCADAC = MemRegisterDef<std::uint32_t, 0xE0>;
...
using ffFUSE_DUVRDINIT = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_DUVRDINIT"), bool>, 1u<<4>;
...
#endif  // ardo_supplemental_atmega32hvbrevb__h
