// Generated for arch atmega8a.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega8a from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega8a_defs.h.

#ifndef ardo_supplemental_atmega8a__h
#define ardo_supplemental_atmega8a__h
...
using ffFUSE_WTDON = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_WTDON"), bool>, 1u<<6>;
...
constexpr unsigned ccSPM_RDY_vect_num = 18;
...
#endif  // ardo_supplemental_atmega8a__h
