// Generated for arch at90s4414.
// This file is generated from the avr-gcc compiler with the mcu
// set to at90s4414 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_at90s4414_defs.h.

#ifndef ardo_supplemental_at90s4414__h
#define ardo_supplemental_at90s4414__h
...
using ffFUSE_FSTRT = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_FSTRT"), bool>, 1u<<2>;
constexpr unsigned ccFUSE_MEMORY_SIZE = 1;
using ffFUSE_SPIEN = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_SPIEN"), bool>, 1u<<1>;
...
constexpr unsigned ccUART_RX_vect_num = 9;
constexpr unsigned ccUART_TX_vect_num = 11;
constexpr unsigned ccUART_UDRE_vect_num = 10;
...
#endif  // ardo_supplemental_at90s4414__h
