...
constexpr unsigned ccANA_COMP_vect_num = 34;
...
using rrTCNT2 = IoRegisterDef<std::uint8_t, 0x27>;
...
constexpr unsigned ccUSI_START_vect_num = 36;
...
constexpr unsigned cc_VECTORS_SIZE = 74;
...
#endif  // ardo_supplemental_ata5272__h
