// Generated for arch attiny24.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny24 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny24_defs.h.

#ifndef ardo_supplemental_attiny24__h
#define ardo_supplemental_attiny24__h
...
using rrOCRA1 = IoRegisterDef<std::uint16_t, 0x2A>;
using rrOCRA1H = IoRegisterDef<std::uint8_t, 0x2B>;
using rrOCRA1L = IoRegisterDef<std::uint8_t, 0x2A>;
using rrOCRB1 = IoRegisterDef<std::uint16_t, 0x28>;
using rrOCRB1H = IoRegisterDef<std::uint8_t, 0x29>;
using rrOCRB1L = IoRegisterDef<std::uint8_t, 0x28>;
...
constexpr unsigned cc_VECTORS_SIZE = 34;
...
#endif  // ardo_supplemental_attiny24__h
