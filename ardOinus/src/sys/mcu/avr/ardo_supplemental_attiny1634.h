// Generated for arch attiny1634.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny1634 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny1634_defs.h.

#ifndef ardo_supplemental_attiny1634__h
#define ardo_supplemental_attiny1634__h
...
constexpr unsigned ccACCE = 3;
constexpr unsigned ccACD = 7;
constexpr unsigned ccACI = 4;
constexpr unsigned ccACIC = 2;
constexpr unsigned ccACIE = 3;
constexpr unsigned ccACIRS0 = 0;
constexpr unsigned ccACIRS1 = 1;
constexpr unsigned ccACIS0 = 0;
constexpr unsigned ccACIS1 = 1;
constexpr unsigned ccACLP = 5;
constexpr unsigned ccACME = 2;
constexpr unsigned ccACO = 5;
using rrACSRA = IoRegisterDef<std::uint8_t, 0x06>;
using rrACSRB = IoRegisterDef<std::uint8_t, 0x05>;
constexpr unsigned ccADATE = 5;
using rrADC = IoRegisterDef<std::uint16_t, 0x00>;
constexpr unsigned ccADC0D = 3;
constexpr unsigned ccADC0EN = 4;
constexpr unsigned ccADC10D = 1;
constexpr unsigned ccADC11D = 2;
constexpr unsigned ccADC1D = 4;
constexpr unsigned ccADC2D = 5;
constexpr unsigned ccADC3D = 6;
constexpr unsigned ccADC4D = 7;
constexpr unsigned ccADC5D = 0;
constexpr unsigned ccADC6D = 1;
constexpr unsigned ccADC7D = 2;
constexpr unsigned ccADC8D = 3;
constexpr unsigned ccADC9D = 0;
using rrADCH = IoRegisterDef<std::uint8_t, 0x01>;
using rrADCL = IoRegisterDef<std::uint8_t, 0x00>;
using rrADCSRA = IoRegisterDef<std::uint8_t, 0x03>;
using rrADCSRB = IoRegisterDef<std::uint8_t, 0x02>;
using rrADCW = IoRegisterDef<std::uint16_t, 0x00>;
constexpr unsigned ccADC_READY_vect_num = 14;
...
using rrADMUX = IoRegisterDef<std::uint8_t, 0x04>;
...
using rrDDRA = IoRegisterDef<std::uint8_t, 0x10>;
...
using rrDIDR2 = MemRegisterDef<std::uint8_t, 0x62>;
...
constexpr unsigned ccEE_RDY_vect_num = 26;
...
using rrGIFR = IoRegisterDef<std::uint8_t, 0x3B>;
using rrGIMSK = IoRegisterDef<std::uint8_t, 0x3C>;
using rrGPIOR0 = IoRegisterDef<std::uint8_t, 0x14>;
using rrGPIOR1 = IoRegisterDef<std::uint8_t, 0x15>;
using rrGPIOR2 = IoRegisterDef<std::uint8_t, 0x16>;
using rrGTCCR = MemRegisterDef<std::uint8_t, 0x67>;
...
using rrICR1 = MemRegisterDef<std::uint16_t, 0x68>;
using rrICR1H = MemRegisterDef<std::uint8_t, 0x69>;
using rrICR1L = MemRegisterDef<std::uint8_t, 0x68>;
...
using rrMCUCR = IoRegisterDef<std::uint8_t, 0x36>;
using rrMCUSR = IoRegisterDef<std::uint8_t, 0x35>;
...
using rrOCR0A = IoRegisterDef<std::uint8_t, 0x18>;
using rrOCR0B = IoRegisterDef<std::uint8_t, 0x17>;
using rrOCR1A = MemRegisterDef<std::uint16_t, 0x6C>;
using rrOCR1AH = MemRegisterDef<std::uint8_t, 0x6D>;
using rrOCR1AL = MemRegisterDef<std::uint8_t, 0x6C>;
using rrOCR1B = MemRegisterDef<std::uint16_t, 0x6A>;
using rrOCR1BH = MemRegisterDef<std::uint8_t, 0x6B>;
using rrOCR1BL = MemRegisterDef<std::uint8_t, 0x6A>;
using rrOSCCAL0 = MemRegisterDef<std::uint8_t, 0x63>;
using rrOSCCAL1 = MemRegisterDef<std::uint8_t, 0x66>;
constexpr unsigned ccOSCRDY = 7;
using rrOSCTCAL0A = MemRegisterDef<std::uint8_t, 0x64>;
using rrOSCTCAL0B = MemRegisterDef<std::uint8_t, 0x65>;
constexpr unsigned ccPCIE0 = 3;
constexpr unsigned ccPCIE1 = 4;
constexpr unsigned ccPCIE2 = 5;
constexpr unsigned ccPCIF0 = 3;
constexpr unsigned ccPCIF1 = 4;
constexpr unsigned ccPCIF2 = 5;
...
using rrPCMSK0 = IoRegisterDef<std::uint8_t, 0x27>;
using rrPCMSK1 = IoRegisterDef<std::uint8_t, 0x28>;
using rrPCMSK2 = IoRegisterDef<std::uint8_t, 0x29>;
...
using rrPINA = IoRegisterDef<std::uint8_t, 0x0F>;
...
using rrPORTA = IoRegisterDef<std::uint8_t, 0x11>;
...
using rrPORTCR = IoRegisterDef<std::uint8_t, 0x13>;
constexpr unsigned ccPRADC = 0;
using rrPRR = IoRegisterDef<std::uint8_t, 0x34>;
constexpr unsigned ccPRTIM0 = 4;
constexpr unsigned ccPRTIM1 = 5;
constexpr unsigned ccPRTWI = 6;
constexpr unsigned ccPRUSART0 = 1;
constexpr unsigned ccPRUSART1 = 2;
constexpr unsigned ccPRUSI = 3;
constexpr unsigned ccPSR10 = 0;
using rrPUEA = IoRegisterDef<std::uint8_t, 0x12>;
...
constexpr unsigned ccQTRIP_vect_num = 27;
constexpr unsigned ccRAMEND = 0x04FF;
constexpr unsigned ccRAMSIZE = 1024;
constexpr unsigned ccRAMSTART = 0x0100;
constexpr unsigned ccREFEN = 5;
...
constexpr unsigned ccSIGNATURE_2 = 0x12;
...
using rrTCCR0A = IoRegisterDef<std::uint8_t, 0x1B>;
using rrTCCR0B = IoRegisterDef<std::uint8_t, 0x1A>;
using rrTCCR1A = MemRegisterDef<std::uint8_t, 0x72>;
using rrTCCR1B = MemRegisterDef<std::uint8_t, 0x71>;
using rrTCCR1C = MemRegisterDef<std::uint8_t, 0x70>;
using rrTCNT0 = IoRegisterDef<std::uint8_t, 0x19>;
using rrTCNT1 = MemRegisterDef<std::uint16_t, 0x6E>;
using rrTCNT1H = MemRegisterDef<std::uint8_t, 0x6F>;
using rrTCNT1L = MemRegisterDef<std::uint8_t, 0x6E>;
using rrTIFR = IoRegisterDef<std::uint8_t, 0x39>;
...
constexpr unsigned ccTIMER0_COMPB_vect_num = 11;
constexpr unsigned ccTIMER0_OVF_vect_num = 12;
...
using rrTIMSK = IoRegisterDef<std::uint8_t, 0x3A>;
...
constexpr unsigned ccTWI_SLAVE_vect_num = 25;
constexpr unsigned ccTWI_vect_num = 25;
constexpr unsigned ccTWPME = 1;
constexpr unsigned ccTWRA = 4;
using rrTWSA = MemRegisterDef<std::uint8_t, 0x7C>;
...
using rrTWSAM = MemRegisterDef<std::uint8_t, 0x7B>;
using rrTWSCRA = MemRegisterDef<std::uint8_t, 0x7F>;
using rrTWSCRB = MemRegisterDef<std::uint8_t, 0x7E>;
using rrTWSD = MemRegisterDef<std::uint8_t, 0x7A>;
...
using rrTWSSRA = MemRegisterDef<std::uint8_t, 0x7D>;
...
using rrUBRR0 = IoRegisterDef<std::uint16_t, 0x21>;
using rrUBRR0H = IoRegisterDef<std::uint8_t, 0x22>;
using rrUBRR0L = IoRegisterDef<std::uint8_t, 0x21>;
using rrUBRR1 = MemRegisterDef<std::uint16_t, 0x74>;
using rrUBRR1H = MemRegisterDef<std::uint8_t, 0x75>;
using rrUBRR1L = MemRegisterDef<std::uint8_t, 0x74>;
constexpr unsigned ccUCPOL0 = 0;
constexpr unsigned ccUCPOL1 = 0;
using rrUCSR0A = IoRegisterDef<std::uint8_t, 0x26>;
using rrUCSR0B = IoRegisterDef<std::uint8_t, 0x25>;
using rrUCSR0C = IoRegisterDef<std::uint8_t, 0x24>;
using rrUCSR0D = IoRegisterDef<std::uint8_t, 0x23>;
using rrUCSR1A = MemRegisterDef<std::uint8_t, 0x79>;
using rrUCSR1B = MemRegisterDef<std::uint8_t, 0x78>;
using rrUCSR1C = MemRegisterDef<std::uint8_t, 0x77>;
using rrUCSR1D = MemRegisterDef<std::uint8_t, 0x76>;
...
using rrUDR0 = IoRegisterDef<std::uint8_t, 0x20>;
using rrUDR1 = MemRegisterDef<std::uint8_t, 0x73>;
...
constexpr unsigned ccUSART0_DRE_vect_num = 17;
constexpr unsigned ccUSART0_RXC_vect_num = 16;
constexpr unsigned ccUSART0_RXS_vect_num = 15;
constexpr unsigned ccUSART0_RX_vect_num = 16;
constexpr unsigned ccUSART0_START_vect_num = 15;
constexpr unsigned ccUSART0_TXC_vect_num = 18;
constexpr unsigned ccUSART0_TX_vect_num = 18;
constexpr unsigned ccUSART0_UDRE_vect_num = 17;
constexpr unsigned ccUSART1_DRE_vect_num = 21;
constexpr unsigned ccUSART1_RXC_vect_num = 20;
constexpr unsigned ccUSART1_RXS_vect_num = 19;
constexpr unsigned ccUSART1_RX_vect_num = 20;
constexpr unsigned ccUSART1_START_vect_num = 19;
constexpr unsigned ccUSART1_TXC_vect_num = 22;
constexpr unsigned ccUSART1_TX_vect_num = 22;
constexpr unsigned ccUSART1_UDRE_vect_num = 21;
constexpr unsigned ccUSBS0 = 3;
constexpr unsigned ccUSBS1 = 3;
using rrUSIBR = IoRegisterDef<std::uint8_t, 0x2D>;
...
using rrUSICR = IoRegisterDef<std::uint8_t, 0x2A>;
constexpr unsigned ccUSICS0 = 2;
constexpr unsigned ccUSICS1 = 3;
constexpr unsigned ccUSIDC = 4;
using rrUSIDR = IoRegisterDef<std::uint8_t, 0x2C>;
...
using rrUSISR = IoRegisterDef<std::uint8_t, 0x2B>;
constexpr unsigned ccUSITC = 0;
constexpr unsigned ccUSIWM0 = 4;
constexpr unsigned ccUSIWM1 = 5;
constexpr unsigned ccUSI_OVERFLOW_vect_num = 24;
constexpr unsigned ccUSI_OVF_vect_num = 24;
constexpr unsigned ccUSI_START_vect_num = 23;
constexpr unsigned ccUSI_STR_vect_num = 23;
constexpr unsigned ccVDEN = 7;
constexpr unsigned ccVDPD = 6;
...
using rrWDTCSR = IoRegisterDef<std::uint8_t, 0x30>;
...
#endif  // ardo_supplemental_attiny1634__h
