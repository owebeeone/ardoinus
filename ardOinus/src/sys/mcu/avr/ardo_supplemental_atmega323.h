// Generated for arch atmega323.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega323 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega323_defs.h.

#ifndef ardo_supplemental_atmega323__h
#define ardo_supplemental_atmega323__h
...
constexpr unsigned ccANA_COMP_vect_num = 18;
constexpr unsigned ccAS2 = 3;
constexpr unsigned ccASB = 6;
constexpr unsigned ccASRE = 4;
...
constexpr unsigned ccCTC10 = 3;
constexpr unsigned ccCTC11 = 4;
...
constexpr unsigned ccEE_RDY_vect_num = 17;
constexpr unsigned ccEIH = 5;
...
constexpr unsigned ccTWI_TST = 1;
...
#endif  // ardo_supplemental_atmega323__h
