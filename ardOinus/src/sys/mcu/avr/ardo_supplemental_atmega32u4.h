// Generated for arch atmega32u4.
// This file is generated from the avr-gcc compiler with the mcu
// set to atmega32u4 from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_atmega32u4_defs.h.

#ifndef ardo_supplemental_atmega32u4__h
#define ardo_supplemental_atmega32u4__h
...
constexpr unsigned ccRAMSIZE = 0xA00;
...
using rrTCNT4 = MemRegisterDef<std::uint16_t, 0xBE>;
using rrTCNT4H = MemRegisterDef<std::uint8_t, 0xBF>;
using rrTCNT4L = MemRegisterDef<std::uint8_t, 0xBE>;
...
constexpr unsigned ccXRAMSIZE = 0x10000;
...
#endif  // ardo_supplemental_atmega32u4__h
