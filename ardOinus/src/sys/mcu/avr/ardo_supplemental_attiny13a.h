// Generated for arch attiny13a.
// This file is generated from the avr-gcc compiler with the mcu
// set to attiny13a from macros specific to avr/io.h.
// Any changes to this file will likely be lost next time this file
// is regenerated. Many any mcu_arch specific changes to 
// ardo_supplemental_attiny13a_defs.h.

#ifndef ardo_supplemental_attiny13a__h
#define ardo_supplemental_attiny13a__h
...
using rrBODCR = IoRegisterDef<std::uint8_t, 0x30>;
constexpr unsigned ccBODS = 1;
constexpr unsigned ccBODSE = 0;
...
constexpr unsigned ccFLASHEND = 1024;
...
using ffFUSE_SELFPRGEN = setl::BitsRW<setl::SemanticType<setl::hash("FUSE_SELFPRGEN"), bool>, 1u<<4>;
...
#endif  // ardo_supplemental_attiny13a__h
